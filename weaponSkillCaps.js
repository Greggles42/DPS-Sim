...
(function (global) {
  ...
  const SkillCapsSpec = {
    ...
    maxCaps: {
      ...
      // 1H Slashing
      '1hs':      [250,   0, 225, 250, 225, 175,  0, 250, 250,    0,   0,   0,   0,   0,   0],
      // 1H Piercing (Piercing skill)
      '1hp':      [240,   0, 225, 240, 225,   0,  0, 250, 250, 200, 110, 225,   0,   0, 225],
      // 2H Blunt
      '2hb':      [250, 175, 225, 250, 225, 175, 252,   0,   0, 200, 110, 110, 225,   0, 225],
      // 2H Slashing
